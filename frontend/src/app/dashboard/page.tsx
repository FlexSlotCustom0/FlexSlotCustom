    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 flex">
      ...
      <aside className="w-64 glass border-r border-white/5 flex flex-col h-screen sticky top-0">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
          ...
          <NavItem icon={<Bot />} label="AI Insights" active={activeTab === 'ai'} onClick={() => setActiveTab('ai')} />
          <NavItem icon={<Settings />} label="Tenant Config" active={activeTab === 'settings'} onClick={() => setActiveTab('settings')} />
        </div>
